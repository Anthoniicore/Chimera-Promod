...
// Kept here (file-local) rather than in the header so every translation unit
// that includes map_load.h shares this single instance, matching tick.cpp/frame.cpp.

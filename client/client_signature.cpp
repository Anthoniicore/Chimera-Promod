...
bool find_block_camera_shake_signature () noexcept {
  ...
  const short block_camera_shake_sig[] = { 0x0F, 0x85, 0xD1, 0x00, 0x00, 0x00, 0x8B, 0x15 };
  add_signature_s2 (block_camera_shake_sig);
...
bool find_loading_screen_signatures() noexcept {
    ...
    const short loading_screen_1_sig[] = {0xC7, 0x05, -1, -1, -1, -1, 0x01, 0x00, 0x00, 0x00, 0x80, 0x3D, -1, -1, -1, -1, 0x01};
    add_signature_s2(loading_screen_1_sig);

    const short loading_screen_2_sig[] = {0xC7, 0x05, -1, -1, -1, -1, 0x08, 0x00, 0x00, 0x00, 0x33};
    add_signature_s2(loading_screen_2_sig);

    const short loading_screen_3_sig[] = {0xC7, 0x05, -1, -1, -1, -1, 0x08, 0x00, 0x00, 0x00, 0x8D, 0x83, -1, -1, 0x00, 0x00, 0x8B, 0xF0};

...
bool find_block_mouse_acceleration_sigs() noexcept;
bool find_mouse_sensitivity_sigs() noexcept;
bool find_fv_mouse_sensitivity_sigs() noexcept;
...
bool find_block_camera_shake_signature () noexcept;

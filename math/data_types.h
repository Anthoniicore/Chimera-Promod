...
// Interpolates between 'p0' and 'p1' using tangents 't0' and 't1'.
// 't' must be in [0, 1]. Produces C1-continuous motion across tick boundaries.
...
// Same for normalized direction vectors (re-normalizes after interpolation).
